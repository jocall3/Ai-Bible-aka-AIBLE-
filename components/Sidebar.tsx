    ...
    <aside className="w-1/3 max-w-sm bg-gray-800/70 border-r border-slate-700 flex flex-col p-4 shadow-2xl shadow-amber-900/20">
      ...
      <nav className="flex-1 overflow-y-auto custom-scrollbar pr-2">
       ...
       <div className="mt-4 pt-4 border-t border-slate-700">
            <button
                onClick={onDownload}
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-amber-600/20 border border-amber-500/30 text-amber-300 font-bold rounded-md hover:bg-amber-500/30 hover:text-white hover:border-amber-500/50 transition-all duration-200"
            >
